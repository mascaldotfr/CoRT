...
let to_the_top = `&nbsp;<a href="#ws-index-title"><svg style="height:1.5em; margin-bottom:0px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M0 0h512v512H0z" fill-opacity="0"></path><path d="M256 47L139.4 202.467l93.6-40.115V359h46V162.352l93.6 40.115L256 47zM144 256L32 480h448L368 256h-71v121h-82V256h-71z" fill="#9ccdf9" fill-opacity="1"></path></svg></a>`;
