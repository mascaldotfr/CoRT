...
export var wzicons = {
	...
	"res_79173.png":generate_relic("syrtis", "#669966")
};
for (let realm in realm_colors) {
	wzicons[`keep_${realm}.gif`] = generate_fort(realm_colors[realm]);
	wzicons[`castle_keep_${realm}.gif`] = generate_castle(realm_colors[realm]);
	wzicons[`wall_keep_${realm}.gif`] = generate_wall(realm_colors[realm]);
}
