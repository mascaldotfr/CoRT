	...
	<li>
		<details class="menudetails">
			...
			<ul class="menudetails">
				...
				<li>${__menu_icons["tools4regnum"]}&nbsp;<a href="https://tools4regnum.de/" target="_blank" title="Game assets in your browser">Tools4Regnum</a>
			</ul>
		</details>
	</li>
	<li>
...
const __menu_footer = function() { return `
	...
	<p> <!--VERSION-->Version: 20260509.133559
