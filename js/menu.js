...
/* viewbox="0 0 512 512" id="menu-cortlogo-svg" */
let __menu_icons = {
	"cortlogo":` <svg viewbox="0 0 512 512" id="menu-cortlogo-svg"  clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" xmlns="http://www.w3.org/2000/svg"><path id="path1" d="M-10-10H530V530H-530Z" fill="#7d2b2b"/><path id="path2" d="m198 30q2-.3 3 1l38 65q1 2 0 3a8e4 8e4 0 01-57 33q-35-29-55 12a176 176 0 00-9 43q-43-48-30-111 4-9 10-16 21 4 41-2 32-11 60-28m114 0a373 373 0 0062 28q21 6 42 2 11 13 13 30 4 56-34 97-1-27-13-52-16-23-40-10a6e3 6e3 0 01-10 8 2e3 2e3 0 01-58-33 2e3 2e3 0 0138-69" fill="#f9f8f8"/><path id="path3" d="m58 34a5 5 0 013 .5q8 10 17 17-19 30-14 66 8 57 52 94 2 29 8 57-75-38-102-118-10-33-2-66 10-31 36-50m392-1q49 33 42 92-8 53-42 93-27 32-64 50l-1-2a283 283 0 0010-55q54-48 52-120-2-21-14-40a96 96 0 0017-18m-217 89q2-.3 3 1l20 39a6e3 6e3 0 0150 114q-19 1-38-.5a4e3 4e3 0 01-34-76 834 834 0 00-30-60 573 573 0 0127-17" fill="#f9f8f8"/><path id="path4" d="m276 122a130 130 0 0129 17l-20 39a2e3 2e3 0 00-18-38 144 144 0 019-18" fill="#f8f6f6"/><path id="path5" d="m226 226q1 .7 2 2a1e3 1e3 0 0018 40 81 81 0 01-4 8q-18 .8-37 .5a3e5 3e5 0 0121-50" fill="#f8f7f7"/><path id="path6" d="m170 324q-2 2-6 2a31 31 0 00-1-11q-9-9-22-8-33 2-32 36 3 47 50 38a60 60 0 0012-4q2 .2 2 2-2 8-10 10-21 6-43 1-37-16-30-56 10-29 40-34 22-3 42 5a10 10 0 011 4 979 979 0 00-2 16" fill="#f5f3f3"/><path id="path7" d="m252 300q29-.2 58 .5 21 6 14 26-6 11-18 16a2e3 2e3 0 0024 38q3 3 8 3v6q-13 .2-25-.5a944 944 0 00-28-42 13 13 0 01-.5-5q23 .8 20-22-4-13-18-12a20 20 0 00-6 1 1e3 1e3 0 000 73l2 2q4 .8 9 .5v6h-41v-6a32 32 0 008-.5q2-.8 2-2 1-36 0-72-5-3-10-3z" fill="#f6f5f5"/><path id="path8" d="m420 322h-5q.4-3-1-5 .4-5-3-8-10-.8-21-.5-.2 37 .5 73l2 2q4 .8 9 .5v6h-41v-6a41 41 0 009-.5l2-2q.8-36 .5-73a242 242 0 00-22 .5l-2 2-1 11q-3 2-6 .5a250 250 0 01-2-22h83a131 131 0 00-2 21" fill="#f5f4f4"/><path id="path9" d="m414 316q1 2 1 5h5q-3 1-6 1z" fill="#baa1a1"/><path id="path10" d="m170 324v3q-3 .4-6-1 3 1 6 1z" fill="#ae8f8f"/><path id="path11" d="m202 328q50-3 38 46-6 13-20 16-44 4-38-40 4-18 22-23" fill="#f6f4f4"/><path id="path12" d="m208 334q15 .5 16 16a121 121 0 010 22q-2 17-18 10-6-5-6-12-4-16 2-31a38 38 0 016-5" fill="#7d2c2c"/><path id="path13" d="m126 416q20-2 41-.5a472 472 0 00-12 16q-1 2-3 2a693 693 0 01-26-18m218 0q20-2 40-.5l-26 20a371 371 0 01-14-19" fill="#f7f6f6"/><path id="path14" d="m98 418a890 890 0 0150 37q-.07 3-2 5l-14 18q-2 1-3 0a1e3 1e3 0 01-48-37 503 503 0 0016-22m314 0q2 .02 4 2a231 231 0 0016 20l-50 38a583 583 0 00-18-23 4e4 4e4 0 0149-38" fill="#f8f7f7"/></svg>`,
	...
	<li>
		<details class="menudetails">
			...
			<ul class="menudetails">
				...
				<li>${__menu_icons["tools4regnum"]}&nbsp;<a href="https://tools4regnum.de/?utm_source=CoRT" target="_blank" title="Game assets in your browser">Tools4Regnum</a>
			</ul>
		</details>
	</li>
	<li>
...
const __menu_footer = function() { return `
	...
	<p> <!--VERSION-->Version: 20260821.204949
